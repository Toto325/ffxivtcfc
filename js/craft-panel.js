...
app._craftReady = function () {
  ...
  root.innerHTML =
    '<div class="craft-layout">' +
      '<div class="craft-col craft-col-left">' +
        '<div class="craft-card">' +
          ...
          '</div>' +
          '<p id="cf-profile-hint-off" class="craft-hint">生產技能全職業共用同一套。若需分別記錄不同職業的進度，可勾選下面的個人設定檔。</p>' +
      ...
      '<div class="craft-col craft-col-right">' +
        ...
        '<div id="cf-auto-block">' +
          ...
          '<div id="cf-solve-nav" class="craft-solve-nav" style="display:none">' +
            '<span class="craft-solve-nav-label"><i class="ph ph-clock-counter-clockwise"></i>瀏覽紀錄</span>' +
    ...
    '<button type="button" id="cf-explore-trigger" class="craft-explore-fab">' +
      '<span class="craft-explore-fab-badge-icon"><i class="ph ph-compass"></i></span>' +
      '<span class="craft-explore-fab-label">圖譜與規劃</span>' +

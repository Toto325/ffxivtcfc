    ...
    function renderWorldRows(g) {
      return g.order.map(function (w) {
        ...
        if (grp.entries.length === 1) {
          ...
          return '<div class="craft-mat-world-row"><span class="w-name">' + w + '</span><span class="w-qty">×' + grp.qty.toLocaleString() + '</span><span class="w-price">' + e.unitPrice.toLocaleString() + '金/個</span></div>';
        }
        return '<div class="craft-mat-world-group">' +
          ...
          grp.entries.map(function (e) {
            return '<div class="craft-mat-world-subrow"><span class="w-qty">×' + (e.qty != null ? e.qty : e.quantity).toLocaleString() + '</span><span class="w-price">' + e.unitPrice.toLocaleString() + '金/個</span></div>';
          }).join('') +
          '</div>';
      }).join('');
    }

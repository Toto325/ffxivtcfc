...
app._craftReady = function () {
    ...
    '<div class="craft-layout">' +
      '<div class="craft-col craft-col-left">' +
        '<div class="craft-card">' +
          ...
          '</div>' +
          '<p id="cf-profile-hint-off" class="craft-hint">生產技能全職業通用，不用選職業。</p>' +
  ...
  function renderExploreCurrentTarget() {
    ...
    $('cf-explore-quickadd').addEventListener('click', function () {
      ...
      setTimeout(function () { if ($('cf-explore-quickadd')) $('cf-explore-quickadd').innerHTML = '<i class="ph ph-plus"></i>加入批次規劃'; }, 1100);
    });
  }

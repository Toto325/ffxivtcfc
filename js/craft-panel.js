...
app._craftReady = function () {
        ...
        if (ings) {
          ...
          if (allResolved && craftCost > 0) {
            if (craftCost < r.totalCost) {
              ...
              html += ' <span class="craft-mat-decision craft-mat-decision-buy">買比較划算</span>';
            }
        ...
        MarketData.resolveBuyCosts(combinedSubNeed).then(function (combinedResults) {
          craftableRows.forEach(function (r) {
            ...
            if (craftCost < buyEntry.totalCost) {
              ...
              hintEl.innerHTML = '<span class="craft-mat-decision craft-mat-decision-buy">買划算</span>';
            }
          });
  ...
  function fillProfitReference(recipe) {
    ...
    Promise.all([costPromise, sellPromise, taxPromise]).then(function (out) {
      const costResults = out[0], sellRef = out[1], taxInfo = out[2];

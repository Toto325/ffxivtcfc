...
app._craftReady = function () {
  ...
  function ensureMarketSettingsPopoverDom() {
    ...
    pop.innerHTML =
      ...
      '<div class="craft-settings-field"><label>資料中心<span class="craft-muted">（材料成本查詢範圍）</span></label><select id="cf-market-dc" class="craft-select craft-select-block"><option value="">資料中心⋯</option></select></div>' +
